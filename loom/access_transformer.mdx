...
You may also refer to the [NeoForge Documentation](https://docs.neoforged.net/docs/advanced/accesstransformers/#the-access-transformer-specification) on this topic if you are new to this.
