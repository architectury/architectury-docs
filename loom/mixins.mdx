...
Fabric Loader uses the `fabric.mod.json` to load mixin configs.

On Forge, the `MixinConfigs` argument is used instead. Loom will handle adding the arguments for you within both the development environment, and the compiled jar.
