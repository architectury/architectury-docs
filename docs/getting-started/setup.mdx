...
# Dependencies
architectury_api_version = 21.1.8
fabric_loader_version = 0.19.5
fabric_api_version = 0.160.0+26.2
neoforge_version = 26.2.0.82
```

:::info[Architectury API 21.1]
21.1 is the current release for Minecraft 26.2 and adds a number of new events. Anything marked
**Added in 21.1** elsewhere in these docs is unavailable on 21.0.x, so set
`architectury_api_version` to at least `21.1` to use it.
:::
