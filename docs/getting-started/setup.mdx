...
# Dependencies
architectury_api_version = 22.0.1
fabric_loader_version = 0.19.5
fabric_api_version = 0.160.5+26.3
neoforge_version = 26.3.0.0-beta
```

:::info[Architectury API 22]
22.0 is the current release for Minecraft 26.3. It contains breaking changes relative to the
21.x releases for Minecraft 26.2; see [Porting from 26.2 to 26.3](../porting/port-26.2-26.3.mdx) for the
full list.
:::
