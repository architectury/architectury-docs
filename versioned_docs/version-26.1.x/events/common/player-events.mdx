...
Events about players: joining and leaving, crafting and smelting, picking up and dropping
items, attacking, opening menus, block breaking speed, and more. Unless noted otherwise these
fire on the server.
...
:::info[Added in 20.1]
`BREAK_SPEED` was added in Architectury API **20.1**.
:::
